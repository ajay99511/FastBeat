...
| | |
|---|---|
| **Status** | ⬜ · **Risk** 🟩 Low · **Depends on** P1-C |
| **Files** | `ui/MainScreen.kt` (L3, L62–63), `viewmodel/PlaybackViewModel.kt` (L286–289), `AndroidManifest.xml` (L30–32) |
...
| | |
|---|---|
| **Status** | ⬜ · **Risk** ⬜ None · **Depends on** P1-E |
...
| | |
|---|---|
| **Status** | ⬜ · **Risk** 🟩 Low · **Depends on** P1-E |
...
| P2-A | Fix `PlaybackService` swallowed catch | 🟩 | P1-E | ⬜ | |
| P2-B | Fix `ThumbnailManager` swallowed catch | 🟩 | P1-E | ⬜ | |
| P2-C | Replace `printStackTrace` ×3 | 🟩 | P1-E | ⬜ | |
