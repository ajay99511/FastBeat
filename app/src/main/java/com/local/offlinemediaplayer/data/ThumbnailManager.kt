...
class ThumbnailManager
    ...
    constructor(
         ...
         */
        private fun cacheKey(video: MediaFile): String = "thumb_${video.id}_${video.size}_${video.dateModified}.jpg"
         ...
         */
        fun generateThumbnails(videos: List<MediaFile>): Flow<Pair<Long, String>> =
            flow {
                for (video in videos) {
